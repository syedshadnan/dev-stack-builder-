      ...
      <div className="container mx-auto px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center justify-center text-center md:hidden">
          <div className="flex items-center justify-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-linear-to-r from-orange-500 via-pink-500 to-purple-500 text-xs font-bold text-white">
              D
            </div>
            <div className="text-xl font-bold text-slate-900">
              <span>Dev</span>
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-4 text-sm text-slate-600">
            {socialLinks.map(({ label, href }, index) => (
              ...
              >
                {index < socialLinks.length - 1 ? `${label} •` : label}
              </a>
            ))}
          </div>

          <div className="mt-5 h-px w-full max-w-xs bg-slate-200" />
        ...
        <div className="mt-10 hidden border-t border-slate-200 pt-6 md:block">
